...
#set_property PACKAGE_PIN A10 [get_ports led_blue]
#set_property IOSTANDARD LVCMOS33 [get_ports led_blue]
#set_property PACKAGE_PIN A9 [get_ports led_green]
#set_property IOSTANDARD LVCMOS33 [get_ports led_green]
#set_property PACKAGE_PIN C9 [get_ports led_red]
...
set_property IOSTANDARD LVCMOS33 [get_ports pwml]
set_property IOSTANDARD LVCMOS33 [get_ports pwmr]