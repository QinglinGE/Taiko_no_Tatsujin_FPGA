...
HD_PWD='C:/Users/yanxinj2/ECE385/Final/Final.runs/don_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log don_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source don_rom.tcl
