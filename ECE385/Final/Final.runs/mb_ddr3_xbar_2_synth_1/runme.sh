...
HD_PWD='C:/Users/yanxinj2/ECE385/Final/Final.runs/mb_ddr3_xbar_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_ddr3_xbar_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_ddr3_xbar_2.tcl
