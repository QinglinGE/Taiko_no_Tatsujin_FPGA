...
HD_PWD='C:/Users/yanxinj2/ECE385/Final/Final.runs/katsu_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log katsu_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source katsu_rom.tcl
