...
#
# Generated by export_simulation on Wed May 01 05:30:57 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './katsu_rom.sh' script.

./katsu_rom.sh -reset_run
...
./katsu_rom.sh -noclean_files

For more information on the script, please type './katsu_rom.sh -help'.
