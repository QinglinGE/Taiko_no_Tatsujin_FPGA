...
#
# Generated by export_simulation on Sat Apr 27 19:08:41 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './mb_ddr3.sh' script.

./mb_ddr3.sh -reset_run
...
./mb_ddr3.sh -noclean_files

For more information on the script, please type './mb_ddr3.sh -help'.
