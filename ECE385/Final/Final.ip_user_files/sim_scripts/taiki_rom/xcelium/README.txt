...
#
# Generated by export_simulation on Wed May 01 20:10:07 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './taiki_rom.sh' script.

./taiki_rom.sh -reset_run
...
./taiki_rom.sh -noclean_files

For more information on the script, please type './taiki_rom.sh -help'.
