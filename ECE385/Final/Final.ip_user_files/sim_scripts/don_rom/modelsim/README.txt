...
#
# Generated by export_simulation on Wed May 01 03:48:28 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './don_rom.sh' script.

./don_rom.sh -reset_run
...
./don_rom.sh -noclean_files

For more information on the script, please type './don_rom.sh -help'.
