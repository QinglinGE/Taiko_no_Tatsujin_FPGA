...
#
# Generated by Vivado on Wed May 01 16:13:54 -0500 2024
...
simulate()
{
  xsim  blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_ddr3.protoinst" -log simulate.log
}
